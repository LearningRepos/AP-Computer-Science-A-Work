...
public class Magpie4
{
      ...
      private String transformIYouStatement(String statement)
    {
        ...
        int positionOfMe = findKeyword (statement, "you", positionOfYou + 3);
    ...
    private String getRandomResponse()
    {
        ...
        String response = "";
        String rando[] = {"Interesting, tell me more.","Hmmm.","Do you really think so?","You don't say.", "Wonderful", "Nice"};

        response = rando[whichResponse];
